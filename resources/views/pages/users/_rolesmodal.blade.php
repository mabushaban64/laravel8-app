                            ...
                            <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                                ...
                                <li class="nav-item mr-3">
                                    <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                        ...
                                        <span class="nav-text font-size-lg">Granted Roles</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mr-3">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_2">
                                        ...
                                        <span class="nav-text font-size-lg">Grant</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mr-3">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                        <span class="nav-icon">
                                            <span class="svg-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/General/Shield-disabled.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
                                                    <path d="M4,4 L11.6314229,2.5691082 C11.8750185,2.52343403 12.1249815,2.52343403 12.3685771,2.5691082 L20,4 L20,13.2830094 C20,16.2173861 18.4883464,18.9447835 16,20.5 L12.5299989,22.6687507 C12.2057287,22.8714196 11.7942713,22.8714196 11.4700011,22.6687507 L8,20.5 C5.51165358,18.9447835 4,16.2173861 4,13.2830094 L4,4 Z" fill="#000000" opacity="0.3"/>
                                        ...
                                        <span class="nav-text font-size-lg">Revoke</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                            </ul>
                    ...
                    <div class="card-body">
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8">
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left">The granted Roles</label>
                                                <div class="col-9">
                                                    <div id="granted_roles_array"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form id="grantRoleForm" name="grantRoleForm" novalidate="">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-3 text-lg-right text-left">Grant Roles</label>
                                                        <div class="col-9">
                                                            <div id="grant_roles_array"></div>
                                                            <span class="text-danger error-text role_error" id="role_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="row">
                                                        <div class="col-3"></div>
                                                        <div class="col-9">
                                                            <button type="submit" id="btn-save-grant" class="btn btn-primary font-weight-bold">Save changes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane px-7" id="kt_user_edit_tab_3" role="tabpanel">
                                    <!--begin::Form-->
                                    <form id="revokeRoleForm" name="revokeRoleForm" novalidate="">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <!--begin::Row-->
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-3 text-lg-right text-left">Revoke Roles</label>
                                                        <div class="col-9">
                                                            <div id="revoke_roles_array"></div>
                                                            <span class="text-danger error-text role_error" id="role_error"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="row">
                                                        <div class="col-3"></div>
                                                        <div class="col-9">
                                                            <button type="submit" id="btn-save-revoke" class="btn btn-primary font-weight-bold">Save changes</button>
