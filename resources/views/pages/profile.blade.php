                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="#" class="font-weight-bolder font-size-h6 text-dark-75 text-hover-primary">{{ Auth::user()->fname }} {{ Auth::user()->lname }}</a>
                            ...
                            <div class="py-9">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="text-muted">{{ Auth::user()->country }}_{{ Auth::user()->city }}</span>
                                </div>
                            </div>
                            <!--end::Contact-->
                            <!--begin::Nav-->
