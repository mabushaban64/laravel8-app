                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="pages/profile/overview.html">Overview</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="pages/profile/projects.html">Projects</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="pages/profile/campaigns.html">Campaigns</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="pages/profile/documents.html">Documents</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="pages/profile/connections.html">Connections</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="pages/profile/activity.html">Activity</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                    </div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    ...
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Nick Logan</a>
                                        <span class="text-gray-400 fw-bold">PHP, SQLite, Artisan CLI</span>
                                    </div>
                                    <!--end::Info-->
                                </div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex flex-column justify-content-between h-100">
                                ...
                                <div class="pt-15 mb-10">
                                    <!--begin::Title-->
                                    <h3 class="text-dark text-center fs-1 fw-bolder lh-lg">Upgrade to Pro
                                    <br />For Limitless Features</h3>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="text-center text-gray-600 fs-6 fw-bold pt-4 pb-1">They stoping you from amazing poorly about drive.
                                    <br />Outlines keep you honest.</div>
                                    <!--end::Text-->
                                    <!--begin::Action-->
